...
def login_page():
    ...
    st.markdown("""
    <h1 style='text-align:center;'>Simple Social</h1>
    <p style='text-align:center;color:gray;'>Share photos and videos instantly</p>
    """, unsafe_allow_html=True)
...
def upload_page():
    ...
    st.markdown("""
    <h2>Create Post</h2>
    <p style="color:gray;">Upload photos or videos</p>
    """, unsafe_allow_html=True)
        ...
        for post in posts:
            ...
            with col2:
                ...
                if post.get('is_owner', False):
                    ...
                    if st.button("❌", key=f"delete_{post['id']}"):
            ...
            if post['file_type'] == 'image':
                ...
                st.image(uniform_url, use_column_width=True)
                ...
                st.video(uniform_video_url, width=500)
                st.caption(caption)
